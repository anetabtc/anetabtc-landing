...
<img src={'/img/f1.png'} /> </div><p><h4>Wrap Bitcoin on Ergo and Cardano</h4></p><div className="text5">Guaranteed and verifiable through transparent and accessible smart contracts.</div>
 </div>
<div className="guide1"><div  className="imgSave">
<img src={'/img/f2.png'} /></div><p><h3>Security and Privacy</h3></p><p /><div className="text6">Leverage built-in privacy and security tools of the most decentralized blockchains.</div>
 </div>
<div className="guide1"> <div  className="imgSave">
<img src={'/img/f3.png'} /></div><p><h3>Research-driven</h3></p><p /><div className="text6">A meticulous approach, ensuring correctness with constant oversight and testing.</div>
</div>
        </div>
          </div>
